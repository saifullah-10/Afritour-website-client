...
export default function BlogsCard({ image }) {
  return (
    <div className="relative my-10 flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
